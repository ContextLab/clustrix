...
def test_simple_filesystem_working():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            paramiko_install_error = result.stderr.decode() if result.stderr else "Unknown error"
    ...
    return {
        ...
        "overall_status": "SUCCESS" if (
            same_institution and 
            paramiko_install_success and 
            paramiko_import_success and 
            filesystem_success
        ) else "PARTIAL",
