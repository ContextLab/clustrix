...
def install_provider_dependencies(
    provider: str, auto_install: bool = True, quiet: bool = False
) -> bool:
    """
...
def ensure_cloud_provider_dependencies(
    ...
    return install_provider_dependencies(
        provider_to_check, auto_install=auto_install, quiet=quiet
    )


def get_installation_command(
    cluster_type: Optional[str] = None, cloud_provider: Optional[str] = None
) -> Optional[str]:
    """
