...
from clustrix.cost_monitoring import (
    BaseCostMonitor, ResourceUsage, CostEstimate, CostReport,
    cost_tracking_decorator, get_cost_monitor, start_cost_monitoring,
    generate_cost_report, get_pricing_info
)
...
class TestResourceUsage:
    ...
    def test_resource_usage_with_gpu(self):
        ...
        gpu_stats = [
            {'gpu_id': 0, 'utilization_percent': 85, 'memory_used_mb': 15000, 'memory_total_mb': 16000}
        ]
...
class TestLambdaCostMonitor:
    ...
    def test_get_instance_recommendations(self):
        ...
        usage = ResourceUsage(
            ...
            memory_total_mb=8192,
            memory_percent=50.0,
            gpu_stats=[{'gpu_id': 0, 'utilization_percent': 25, 'memory_utilization_percent': 20}]
        )
...
class TestAWSCostMonitor:
    ...
    def test_get_region_pricing_comparison(self):
        ...
        assert regional_pricing['eu-west-1']['on_demand_hourly'] > regional_pricing['us-east-1']['on_demand_hourly']
...
class TestGCPCostMonitor:
    ...
    def test_estimate_cost_on_demand(self):
        """Test on-demand cost estimation."""
        estimate = self.monitor.estimate_cost("a2-highgpu-1g", 2.0, use_preemptible=False)
    ...
    def test_estimate_cost_preemptible(self):
        ...
        estimate = self.monitor.estimate_cost("a2-highgpu-1g", 2.0, use_preemptible=True)
    ...
    def test_estimate_cost_with_sustained_use_discount(self):
        ...
        estimate = self.monitor.estimate_cost("n2-standard-4", 2.0, sustained_use_percent=80)
    ...
    def test_estimate_sustained_use_discount(self):
        """Test sustained use discount calculation."""
        discount_info = self.monitor.estimate_sustained_use_discount(600)  # 600 hours per month
    ...
    def test_get_preemptible_pricing_info(self):
        ...
        assert preemptible_pricing['a2-highgpu-1g'] < self.monitor.compute_pricing['a2-highgpu-1g']
...
class TestCostMonitoringUtilities:
    ...
    def test_generate_cost_report(self, mock_get_monitor):
        ...
        # Mock the monitor
        mock_monitor = mock.Mock()
        mock_monitor.get_resource_usage.return_value = ResourceUsage(50.0, 4096, 8192, 50.0)
        mock_monitor.estimate_cost.return_value = CostEstimate("test", 1.0, 1.0, 1.0)
        mock_monitor.get_cost_optimization_recommendations.return_value = ["Test recommendation"]
        mock_get_monitor.return_value = mock_monitor
