...
def test_gcp_pricing_api():
    ...
    try:
        ...
        cost_monitor = GCPCostMonitor(region=gcp_creds["region"], use_pricing_api=True)
        ...
        for machine_type in test_machine_types:
            try:
                ...
                if cost_estimate and cost_estimate.estimated_cost > 0:
                    print(
                        f"   ✅ {machine_type}: ${cost_estimate.hourly_rate:.4f}/hour (${cost_estimate.estimated_cost:.4f} total)"
                    )
