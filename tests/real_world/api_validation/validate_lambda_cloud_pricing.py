...
def validate_lambda_cloud_pricing():
    ...
    try:
        ...
        test_instances = ["a10", "a100_40gb", "h100", "4xa100_40gb", "rtx6000ada"]
        ...
        for instance_type in test_instances:
            ...
            try:
                cost_estimate = monitor.estimate_cost(
                    instance_type=instance_type, hours_used=1.0
                )

                results[instance_type] = {
                    "hourly_cost": cost_estimate.hourly_rate,
                    "total_cost": cost_estimate.estimated_cost,
                    "pricing_source": getattr(
                        cost_estimate, "pricing_source", "hardcoded"
                    ),
                ...
                print(
                    f"     💰 ${cost_estimate.hourly_rate:.3f}/hr (${cost_estimate.estimated_cost:.3f} total)"
                )
