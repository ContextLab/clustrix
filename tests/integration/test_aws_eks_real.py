...
from clustrix.kubernetes.cluster_provisioner import KubernetesClusterProvisioner, ClusterSpec
...
def test_aws_eks_provisioning():
    ...
    try:
        ...
        print(f"Run: python -c \"from clustrix.kubernetes.cluster_provisioner import KubernetesClusterProvisioner; p = KubernetesClusterProvisioner(); p._destroy_cluster('{cluster_name}')\"")
        print("=" * 60)
