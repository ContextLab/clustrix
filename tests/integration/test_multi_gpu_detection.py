#!/usr/bin/env python3
"""
Test multi-GPU detection on gpu_cluster.
"""
...
""",
            ...
            if pytorch_result.returncode == 0:
                ...
                result["pytorch_detection"] = {"success": True, "info": pytorch_info}
            else:
            ...
            result["pytorch_detection"] = {"success": False, "error": str(e)}
    ...
    try:
        ...
        pytorch_gpus = (
            result["pytorch_detection"]["info"]["device_count"]
            if result["pytorch_detection"]["success"]
            else 0
        )
